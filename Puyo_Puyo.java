...
/**
 * Esta clase utiliza el projecto "Game in Java" para iniciar programa.
 * utiliza las variables siguientes:
 * gp -> contiene el tablero de juego
 * width -> aplitud del tablero
 * height -> altura del tablero
 * rows -> numero de filas del tablero
 * cols -> numero de columnas del tablero
 * puyo_len -> longitud del tablero
 * screenSize -> tamano de la pantalla del jugador
 */
...
public class Puyo_Puyo extends JFrame {
    ...
    /**
     * Metodo que prepara un movimiento
     * @param m Posicion
     * @return Posicion relativa a la pantalla del usuario
     */
    ...
    /**
     * Este metodo se encarga de, unicamente, inicializar el tablero
     * con los posibles movimientos que se puedan realizar
     * @param rows Nombre de filas a iniciar
     * @param cols Nombre de columnas a iniciar
     * @return Si el tablero se ha inicializado correctamente devuelve true, sino false
     */
    ...
    /**
     * Es el constructor encargado de iniciar to.do el entorno del juego,
     * es decir, el panel adaptado al amplio y alto del usuario
     */
    ...
    /**
     * Este metodo sirve para iniciar el programa
     * @param args Este parametro no se utiliza
     */
